...
unique, counts = np.unique(np.reshape(train_labels, (108,)), axis=-1, return_counts=True)
print(dict(zip(unique, counts)))

## test set의 각 class 별 images 수 확인
unique, counts = np.unique(np.reshape(test_labels, (12,)), axis=-1, return_counts=True)
print(dict(zip(unique, counts)))
...
model.save('/home/longstone123/test_model2.h5')