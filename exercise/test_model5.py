...
image_datas = glob('/home/longstone123//*/*.jpg')
...
## dataset 구성
train_dataset = tf.data.Dataset.from_tensor_slices((train_images, train_labels)).shuffle(buffer_size=2274).batch(N_BATCH).repeat()
...
model.save('/home/longstone123/test_model5.h5')